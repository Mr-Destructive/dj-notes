...
BASE_DIR = Path(__file__).resolve(strict=True).parent.parent.parent / "dj_notes"
# Path to the service worker implementation.  Default implementation is empty.
PWA_SERVICE_WORKER_PATH = getattr(settings, 'PWA_SERVICE_WORKER_PATH', os.path.join(BASE_DIR, 'static', 'js', 'serviceworker.js'))
